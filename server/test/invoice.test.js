...
describe('Invoice model', () => {
  let invoice = new Invoice({ debtor: "ABC Cars", due: "2018-12-12", value: 500, service: "Maintenance" })
  ...
  it('should be invalid if the debtor company is not supplied', (done) => {
    emptyInvoice.validate((err) => {
      expect(err.errors.debtor).to.exist
      done()
    })
  })
